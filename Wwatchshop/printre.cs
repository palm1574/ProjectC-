...
{
    public partial class printre : Form
    {
        public printre()
        {
            InitializeComponent();
        ...
        #endregion
        #region DataGrid
        private void printre_Load(object sender, EventArgs e)
        {
            showEquipment();
        }
        ...
        private void dataEquiment_CellClick(object sender, DataGridViewCellEventArgs e)//Function Show Data From DataGridView To TextBox
        {
            ...
            textBox6.Text = dataEquiment.Rows[e.RowIndex].Cells["tel"].FormattedValue.ToString();
            textBox7.Text = dataEquiment.Rows[e.RowIndex].Cells["paystatus"].FormattedValue.ToString();
            textBox8.Text = dataEquiment.Rows[e.RowIndex].Cells["price"].FormattedValue.ToString();
        }
        private void button1_Click(object sender, EventArgs e)//Function Config Receipt Show BTN
        {
            txtResult.Clear();
            txtResult.Text += "****************************************************************************\n";
            txtResult.Text += "***                                              ใบเสร็จ                                                  ***\n";
            txtResult.Text += "****************************************************************************\n";
            ...
            txtResult.Text += "โทร :" + textBox6.Text + "\n\n";
            txtResult.Text += "การจ่ายเงิน :" + textBox7.Text + "\n\n";
            txtResult.Text += "ราคา :" + textBox8.Text +" บาท\n\n\n";
        ...
        {
            string message = "ต้องการจะปริ้นใบเสร็จใช่หรือไม่?";
            string title = "เตือน";
